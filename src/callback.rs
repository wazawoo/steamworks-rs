...
impl CallbackResult {
    pub unsafe fn from_raw(discriminator: i32, data: *mut c_void) -> Option<Self> {
        Some(match discriminator {
            ...
            LobbyGameCreated::ID => Self::LobbyGameCreated(LobbyGameCreated::from_raw(data)),
            ...
            ScreenshotRequested::ID => Self::ScreenshotRequested(ScreenshotRequested::from_raw(data)),
